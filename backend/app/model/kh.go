...
type KH struct {
	...
	SceneParam   string     `gorm:"column:scence_param" json:"scence_param"`
	VerifyStatus int        `gorm:"column:verify_status;type:int;not null;default:1;comment:'验证状态 1: 未处理 2: 角色确认 3：验证 4: 用户信息确认';" json:"verify_status"`
